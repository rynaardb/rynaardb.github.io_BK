...
This will generate Swift documentation using the default options but your can actually do a whole lot more. You can always have a look at all the options available by running: `jazzy -h`.
